...
rockParticleGun::rockParticleGun()
	:G4ParticleGun(1),
	particleTable(G4ParticleTable::GetParticleTable()),
	positionFlag(0),
	particleFlag(0),
	pMessenger(0),monoEnergy(1.0*keV)

{
	pMessenger = new rockParticleGunMessenger(this);
...
void rockParticleGun::GeneratePrimaryVertex(G4Event* anEvent)
{
	G4ThreeVector vPos;
...
void rockParticleGun::GenerateNeutron(G4PrimaryParticle* neutron[1])
{
...
void rockParticleGun::GenerateFluxNeutron(G4PrimaryParticle* neutron[1],G4ThreeVector vPos)
{
	G4ParticleDefinition* pD = particleTable->FindParticle("neutron");
	neutron[0] = new G4PrimaryParticle(pD);
    //Set energy
...
void rockParticleGun::GenerateFluxNeutronSp(G4PrimaryParticle* neutron[1],G4ThreeVector vPos)
{
	G4ParticleDefinition* pD = particleTable->FindParticle("neutron");
	neutron[0] = new G4PrimaryParticle(pD);
    //Set energy
...
void rockParticleGun::GenerateFission(G4PrimaryParticle* neutron[1])
{
	G4ParticleDefinition* pD = particleTable->FindParticle("neutron");
	neutron[0] = new G4PrimaryParticle(pD);
    //Set energy
...
void rockParticleGun::GenerateMuon(G4PrimaryParticle* muon[1])
{
...
G4double rockParticleGun::LogLogInterpolatorCalculate(G4double x){
...
G4double rockParticleGun::LogLogInterpolatorCalculateSp(G4double x){
...
G4double rockParticleGun::LogLogInterpolatorCalculateFission(G4double x){
...
const G4ThreeVector& rockParticleGun::PutCentre(){
	static G4ThreeVector vPos(0.0,0.0,0.0);
	return vPos;
}

const G4ThreeVector& rockParticleGun::PutTop(){
	static G4ThreeVector vPos(0.0,0.0,49.9*cm);
	return vPos;
}
const G4ThreeVector& rockParticleGun::PutFlux(){
