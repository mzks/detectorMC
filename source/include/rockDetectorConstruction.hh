#ifndef rockDetectorConstruction_h
#define rockDetectorConstruction_h 1
...
class G4UserLimits;
class rockDetectorMessenger;



class rockDetectorConstruction : public G4VUserDetectorConstruction
{
  public:
  
    rockDetectorConstruction();
   ~rockDetectorConstruction();
  ...
  private:
     ...
     rockDetectorMessenger* detectorMessenger;  //pointer to the Messenger
