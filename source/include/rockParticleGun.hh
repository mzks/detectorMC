#ifndef rockParticleGun_h
#define rockParticleGun_h 1
...
class G4Event;
class rockDetectorConstraction;
class rockParticleGunMessenger;


class rockParticleGun : public G4ParticleGun
{
	friend class rockParticleGunMessenger;
	public:
	rockParticleGun();
	~rockParticleGun();
	...
	const rockDetectorConstraction*		rockDC;
	...
	rockParticleGunMessenger*	pMessenger;
